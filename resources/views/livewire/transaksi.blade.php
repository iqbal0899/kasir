<div>
   <div class="container" >
    <div class="row mt-2">
        <div class="col-12">
            @if (!$transaksiAktif)
            <button class="btn btn-primary" wire:click='transaksiBaru'>Tansaksi Baru</button>
            @else
            <button class="btn btn-danger" wire:click='batalTransaksi'>Batal Tansaksi</button>
            @endif
    ...
    <div class="row mt-2">
        ...
        <div class="card border-primary">
            <div class="card-body">
                ...
                <input type="text" class="form-control" placeholder="No Barcode" wire:model.live='kode'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                wire:click='hapusProduk ({{ $produk->id }})'>Hapus Produk</button>
                        </tr>
